...
class PaginationServiceTest {
    ...
    void givenCurrentPageNumberAndTotalPages_whenCalculation_thenReturnPaginationBarNumbers(int currentPageNumber, int totalPages, List<Integer> expected) {
        // given
    ...
    static Stream<Arguments> givenCurrentPageNumberAndTotalPages_whenCalculation_thenReturnPaginationBarNumbers() {
        return Stream.of(
